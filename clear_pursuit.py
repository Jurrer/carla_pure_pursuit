...
def game_loop():
    ...
    try:
        ...
        gaz_max = 0.5  # ograniczenie maksymalnej wartości zadawanego gazu
        ...
        while True:
            ...
            lok_wzgl_cel.x = odl_cel * math.sin(kat_glob_cel - math.radians(sam_kat))  # odległość x
            lok_wzgl_cel.y = odl_cel * math.cos(kat_glob_cel - math.radians(sam_kat))  # odległość y
